// # Javascript
// ## Đề bài:
// Email là một thông tin nhạy cảm và đôi khi chúng ta cần thay thế email trong một chuỗi bằng một chuỗi cố định như `"hidden@example.com"`.
// Trong bài tập này, bạn sẽ viết một hàm để tìm và thay thế tất cả các địa chỉ email trong một chuỗi văn bản.
...
function replaceEmail(inputString){
    const emailRegex = /[a-zA-Z0-9._]+@[a-zA-Z.]+/g; //Tìm email trong chuỗi: [a-zA-Z0-9._] -> tên người dùng, [a-zA-Z.] -> domain, g: tìm tất cả các email khác
    return inputString.replace(emailRegex,"hidden@example.com");
}

const inputStr = "Liên hệ với tôi qua email john.doe@example.com hoặc support@mydomain.com";
console.log(replaceEmail(inputStr));